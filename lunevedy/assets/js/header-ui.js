...
function doWidthSectionDesktop() {
    ...
    if (opt==="1") {
        iframe.contentWindow.document.querySelector('.'+section_class).classList.add("section-width-960px");
    }
    else if (opt==="2") {
        iframe.contentWindow.document.querySelector('.'+section_class).classList.add("section-width-1024px");
    }
    else if (opt==="3") {
        iframe.contentWindow.document.querySelector('.'+section_class).classList.add("section-width-1140px");
    }
    else if (opt==="4") {
        iframe.contentWindow.document.querySelector('.'+section_class).classList.add("section-width-1320px");
    }
    else if (opt==="5") {
        iframe.contentWindow.document.querySelector('.'+section_class).classList.add("section-width-1536px");
    }
}

function deleteWidthSectionDesktop() {
    iframe.contentWindow.document.querySelector('.'+section_class).classList.remove("section-width-960px");
    iframe.contentWindow.document.querySelector('.'+section_class).classList.remove("section-width-1024px");
    iframe.contentWindow.document.querySelector('.'+section_class).classList.remove("section-width-1140px");
    iframe.contentWindow.document.querySelector('.'+section_class).classList.remove("section-width-1320px");
    iframe.contentWindow.document.querySelector('.'+section_class).classList.remove("section-width-1536px");                
}
