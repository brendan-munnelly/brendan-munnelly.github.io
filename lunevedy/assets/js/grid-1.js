...
function doWidthColOne() {
    ...
    if (opt==="0") {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("col-1-width-960px");
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("col-1-width-1140px");
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.add("col-1-width-800px");
    }

    else if (opt==="1") {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("col-1-width-800px");
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("col-1-width-1140px");
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.add("col-1-width-960px");
    }

    else if (opt==="2") {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("col-1-width-800px");
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("col-1-width-960px");
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.add("col-1-width-1140px");
    }    
}
...
function doColOneAlign() {
    ...
    if (selectedValue==="left") {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.remove("text-center");
    }
    else if (selectedValue==="center") {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').classList.add("text-center"); 
    }
}
...
function doColOneH2() {
    ...
    if (!document.getElementById("cb_col_1_h2").checked) {
        ...
        const currentDiv = iframe.contentWindow.document.querySelector('.'+section_class+' .col-1');
        if (!iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 .container-upper-label')) {
            currentDiv.prepend(newH2);
        }
        else {
            iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 .container-upper-label').insertAdjacentHTML('afterend', content_header_h2_col_1); 
        }
    }
}

function removeColOneH2() {
    if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h2')) {
        document.getElementById("btn_col_1_h2_text").disabled=true;
        const elH2 = iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h2');
        elH2.remove();
        if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1.text-center')) {
            iframe.contentWindow.document.querySelector('.'+section_class).innerHTML = iframe.contentWindow.document.querySelector('.'+section_class).innerHTML.replace('<div class=\"col-1 text-center\">\n\t\t\t', '<div class=\"col-1 text-center\">');
        }
        if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1')) {
            iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').innerHTML = iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').innerHTML.replace('<div class=\"col-1\">\n\t\t\t', '<div class=\"col-1\">');
        }
...
function removeColOneH3() {
    if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h3')) {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h3').remove();
    ...
    else if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h3')) {
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h3').remove();
        document.getElementById("btn_col_1_h3_text").disabled=true;
    }
    if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h2')) {
        iframe.contentWindow.document.querySelector('.'+section_class).innerHTML = iframe.contentWindow.document.querySelector('.'+section_class).innerHTML.replace('<\/h2>\n\t\t\t', '<\/h2>');
    }
    if ( (!iframe.contentWindow.document.querySelector('.'+section_class+' .col-1 h2')) && (!iframe.contentWindow.document.querySelector('.'+section_class+'.col-1 h3')) ) {
        removeColOne();
    }
...
function doColOne() {
    if (!document.getElementById("cb_col_1").checked) {
        ...
        iframe.contentWindow.document.querySelector('.'+section_class).prepend(newUpperBlockDiv);
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').innerHTML = iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').innerHTML.replace('',  content_header_upper_block_col_2_3_4);
        iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').innerHTML = iframe.contentWindow.document.querySelector('.'+section_class+' .col-1').innerHTML.replace('<div class="col-1 text-center">', '\n\n\t\t<div class="col-1 text-center">');
        // Enable properties
...
function removeColOne() {
    if (iframe.contentWindow.document.querySelector('.'+section_class+' .col-1')) {
        const elCol1 = iframe.contentWindow.document.querySelector('.'+section_class+' .col-1');
        elCol1.remove();
        col_no = col_no.slice(1)
        iframe.contentWindow.document.querySelector('.'+section_class).innerHTML = 
        iframe.contentWindow.document.querySelector('.'+section_class).innerHTML.replace("\n\n\t\t<div class=\""+col_no+"\">", "<div class=\""+col_no+"\">");
...
// console.log("grid-1.js has loaded.")