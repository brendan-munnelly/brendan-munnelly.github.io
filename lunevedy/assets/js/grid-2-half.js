...
function doUpperLabel() {
    ...
    if (!document.getElementById("cb_upperLabelOn").checked) {
        ...
        removeUpperLabel();
        iframe.contentWindow.document.querySelector("section .col-2 h2").insertAdjacentHTML("beforebegin", "<div class=\"container-upper-label\"><span>CATEGORY<\/span><\/div>\n\n\t");
...
function doColH3() {
    ...
    if (!document.getElementById("cb_H3On").checked) {
        ...
        if (!iframe.contentWindow.document.querySelector(".cols-2-half .col-2 h3")) {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > p:nth-of-type(1)").insertAdjacentHTML("afterend", assets_header_h3);
...
function removeColH3() {
    iframe.contentWindow.document.querySelector("section.cols-2-half .col-2 h3").remove();
...
function doLists() {
    ...
    if (selectedValue==="list-none") {
        ...
        if (iframe.contentWindow.document.querySelector('.cols-2-half .col-2 > h3')) {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > h3").insertAdjacentHTML("afterend", content_paras_2);
        }
        else {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > p:nth-of-type(1)").insertAdjacentHTML("afterend", content_paras_2);
        }
    }
        ...
        if (iframe.contentWindow.document.querySelector('.cols-2-half .col-2 > p:nth-of-type(2)')) {
            iframe.contentWindow.document.querySelector('.cols-2-half .col-2 > p:nth-of-type(2)').remove();
        }

        // Add short list after h3 or first paragraph.
        if (iframe.contentWindow.document.querySelector('.cols-2-half .col-2 > h3')) {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > h3").insertAdjacentHTML("afterend", content_ul_short);
        }
        else {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > p:nth-of-type(1)").insertAdjacentHTML("afterend", content_ul_short);
        }
    }
        ...
        // Add short list after h3 or first paragraph.
        if (iframe.contentWindow.document.querySelector('.cols-2-half .col-2 > h3')) {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > h3").insertAdjacentHTML("afterend", content_ul_long);
        }
        else {
            iframe.contentWindow.document.querySelector(".cols-2-half .col-2 > p:nth-of-type(1)").insertAdjacentHTML("afterend", content_ul_long);
        }
    }
}

function removeLists() {
   if (iframe.contentWindow.document.querySelector(".cols-2-half .col-2 ul")) {
        iframe.contentWindow.document.querySelector(".cols-2-half .col-2 ul").remove();
    }
}
...
function doButtonsAlignDesktop() {
    ...
    if (iframe.contentWindow.document.querySelector(".container-btn")) {  
        ...
        elBtns = iframe.contentWindow.document.querySelector(".container-btn");
