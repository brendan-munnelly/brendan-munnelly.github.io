    ...
    function suppressBubblingClicks(event) {
        ...
        function getColorID(color_code) {
            ...
            /* secondary button text colour: active */
                ...
                sub_string = "a.btn-secondary:active { color";
                doUpdateArray(sub_string,newStyle); 
            }
            /* secondary button background colour: passive */
                ...
                sub_string = "a.btn-secondary:visited { background-color";
                doUpdateArray(sub_string,newStyle); 
            }
            /* secondary button background colour: active */
                ...
                sub_string = "a.btn-secondary:active { background-color";
                doUpdateArray(sub_string,newStyle); 
            }
            /* secondary button border colour: passive */
                ...
                sub_string = "a.btn-secondary:visited { border-color";
                doUpdateArray(sub_string,newStyle); 
            }
            /* secondary button border colour: active */
                ...
                sub_string = "a.btn-secondary:active { border-color";
                doUpdateArray(sub_string,newStyle); 
            }
...
function doVisTypeSplit() { 
    ...
    if (selectedValue==="pictures") {
        ...
        child_obj.innerHTML = "<img src=\"https:\/\/munnelly.com/lunadoge/assets/img/800x800-food-mobile.jpg\" alt=\"Commerce\">";
