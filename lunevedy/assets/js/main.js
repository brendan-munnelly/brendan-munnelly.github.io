    ...
    function suppressBubblingClicks(event) {
        ...
        function getColorID(color_code) {
            ...
            /* Text colour: active */
                ...
                newStyle = "."+section_class+" a.btn-primary:focus,\n."+section_class+" a.btn-primary:hover,\n."+section_class+" a.btn-primary:active { color: var("+color_code+") }\n\n";
            ...
            /* Text colour: active */
                ...
                newStyle = "."+section_class+" a.btn-secondary:focus,\n."+section_class+" a.btn-secondary:hover,\n."+section_class+" a.btn-secondary:active { color: var("+color_code+") }\n\n";
...
document.querySelector("#dd_buttons").addEventListener("change", doButtons);
    ...
    function addButtons(el_cols,btn_class) {
...
if (document.querySelector("#content-1 .mydivheader span")) {
    document.querySelector("#content-1 .mydivheader span").addEventListener("click", hideDialogBox);
}

if (document.querySelector("#content-2 .mydivheader span")) {
    document.querySelector("#content-2 .mydivheader span").addEventListener("click", hideDialogBox);
}

if (document.querySelector("#content-3 .mydivheader span")) {
    document.querySelector("#content-3 .mydivheader span").addEventListener("click", hideDialogBox);
}
if (document.querySelector("#content-4 .mydivheader span")) {
    document.querySelector("#content-4 .mydivheader span").addEventListener("click", hideDialogBox);
}
if (document.querySelector("#content-5 .mydivheader span")) {
    document.querySelector("#content-5 .mydivheader span").addEventListener("click", hideDialogBox);
}
