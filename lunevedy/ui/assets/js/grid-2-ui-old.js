...
document.querySelector("#picker-box").addEventListener('click', handleLabelClick);
    ...
    function handleLabelClick(event) {
        ...
        /* Text colour: passive */
            ...
            newStyle = section_theme+" "+classColBtn+":link,\n"+section_theme+" "+classColBtn+":visited { color: var("+color_code+") }\n\n";
            sub_string = classColBtn+":visited { color";
            doUpdateArray(sub_string,newStyle);
        }

        /* Text colour: active */
        else if (btn_id === "btn_cols_text_active") {
            newStyle = section_theme+" "+classColBtn+":focus,\n"+section_theme+" "+classColBtn+":hover,\n"+section_theme+" "+classColBtn+":active { color: var("+color_code+") }\n\n";
            sub_string = +classColBtn+":active { color";
            doUpdateArray(sub_string,newStyle);
        }

        /* Background colour: passive */
        else if (btn_id === "btn_cols_bg_passive") {
            newStyle = section_theme+" "+classColBtn+":link,\n"+section_theme+" "+classColBtn+":visited { background-color: var("+color_code+") }\n\n";
            sub_string = classColBtn+":visited { background-color";
            doUpdateArray(sub_string,newStyle);
        }

        /* Background colour: active */
        else if (btn_id === "btn_cols_bg_active") {
            newStyle = section_theme+" "+classColBtn+":focus,\n"+section_theme+" "+classColBtn+":hover,\n"+section_theme+" "+classColBtn+":active { background-color: var("+color_code+") }\n\n";
            sub_string = classColBtn+":active { background-color";
            doUpdateArray(sub_string,newStyle);
        }

        /* Border colour: passive */
        else if (btn_id === "btn_cols_border_passive") {
            newStyle = section_theme+" "+classColBtn+":link,\n"+section_theme+" "+classColBtn+":visited { border-color: var("+color_code+") }\n\n";
            sub_string = classColBtn+":visited { border-color";
            doUpdateArray(sub_string,newStyle);
        }

        /* Border colour: active */
        else if (btn_id === "btn_cols_border_active") {
            newStyle = section_theme+" "+classColBtn+":focus,\n"+section_theme+" "+classColBtn+":hover,\n"+section_theme+" "+classColBtn+":active { border-color: var("+color_code+") }\n\n";
            sub_string = classColBtn+":active { border-color";
            doUpdateArray(sub_string,newStyle);
        }
