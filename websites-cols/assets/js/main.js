...
function doGridWidth(){
    ...
    if (opt==="0") {
        const el = document.querySelector('.wrapper-narrow-flex');
        console.log("Grid Width to: 100");
        el.classList.add("wrapper-wide-flex");
        el.classList.remove("wrapper-narrow-flex");
    }

    else if (opt==="1") {
        const el = document.querySelector('.wrapper-wide-flex');
        console.log("Grid Width to: 85");
        el.classList.add("wrapper-narrow-flex");
        el.classList.remove("wrapper-add-flex");
    }
}
